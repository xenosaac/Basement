    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-white/40">
          Top traders ranked by net worth (balance + position value).
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className={`text-sm font-medium ${isMe ? "text-accent" : "text-white"}`}>
                ...
                <div className="shrink-0 text-right">
                  ...
                  <span className="text-xs text-white/30 ml-1">VirtualUSD</span>
                </div>
                ...
                <div className="shrink-0 text-right">
                  <span className={`text-sm font-semibold ${
                    ...
                    {isPositive ? "+" : ""}{formatUSD(entry.profit)}
                  </span>
                  <span className="text-xs text-white/30 ml-1">P&L</span>
                </div>
              </div>
            );
          })}
